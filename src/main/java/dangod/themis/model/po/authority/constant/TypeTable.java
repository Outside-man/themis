...
public class TypeTable {
    ...
    static{
        ...
        TYPE_TABLE.put(6L, new AuthorityType(6L, "个人学生信息查看", null, MENU_TABLE.get(9L)));
        TYPE_TABLE.put(7L, new AuthorityType(7L, "基础信息管理", null, MENU_TABLE.get(8L)));
        TYPE_TABLE.put(8L, new AuthorityType(8L, "班级学生信息管理", null, MENU_TABLE.get(10L)));
        TYPE_TABLE.put(9L, new AuthorityType(9L, "专业学生信息管理", null, MENU_TABLE.get(11L)));
        TYPE_TABLE.put(10L, new AuthorityType(10L, "全校学生信息管理", null, MENU_TABLE.get(12L)));
